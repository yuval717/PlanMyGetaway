...
namespace Project_01
{
    public partial class Order : System.Web.UI.Page
    {
        ...
        string StartDayTime_, EndDayTime_;
        // להוסיף כפתור אישור לבחירת ההעדפות - לוודא שנבחר לפחות העדפה אחת**********
        ...
        protected async void Create_Click(object sender, EventArgs e)
        {
            ...
            string time1 = EndDayTime.Text; // "12:30"
            string time2 = StartDayTime.Text; // "10:15"
