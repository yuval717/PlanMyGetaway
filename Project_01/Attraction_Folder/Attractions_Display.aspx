<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Attractions_Display.aspx.cs" Inherits="Project_01.Attractions_Display" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="AttractionsDisplay.css" />
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DataList ID="AttractaionDisplay" runat="server" RepeatDirection="Horizontal" RepeatColumns="4" CellSpacing="3" OnItemDataBound="DataList1_ItemDataBound" OnItemCommand="AttractaionDisplay_ItemCommand">
        <ItemTemplate>
            <div class="item">
                <table class="table">
                    <tr>
