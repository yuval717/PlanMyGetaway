<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="AttractionDisplay_Admin.aspx.cs" Inherits="Project_01.AttractionDispaly_Admin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="AttractionDisplay_Admin.css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="AttractionHours" runat="server" Text="שעות פעילות" CommandName="Hours" CssClass="Controls"/>
                            </td>
                            <td>
    ...
    <%-- דיב נפתח טווח שעות --%>
    <div id="Hours" class="GapDiv" style="display: none; right:39%; top:42.8%" runat="server">
        <br />
        <br />
        <asp:Label ID="Label2" CssClass="label-style-black" runat="server" Text="שעת פתיחה"></asp:Label>
        <asp:TextBox ID="OpeningHour" CssClass="Textbox-style-black" runat="server" TextMode="Time" Style="width:180px ; height:15.5px;" ></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label3" CssClass="label-style-black" runat="server" Text="שעת סגירה"></asp:Label>
        <asp:TextBox ID="ClosingHour" CssClass="Textbox-style-black" runat="server" TextMode="Time" Style="width:180px ; height:16px;" ></asp:TextBox>
        <br />
        <br />
        <br />
        <br />
        <asp:Button ID="HoursDone" CssClass="button-style" runat="server" Text="אישור" OnClick="HoursDone_Click" />
    </div>

    <%-- דאטאליסט אטרקציות --%>
    <div style="height:100px;"></div>
    <asp:Panel ID="Panel2" CssClass="container" runat="server" ScrollBars="Vertical" Height="576px" Style="overflow-y: auto;">
    <asp:DataList ID="AttractaionDisplay" runat="server" RepeatDirection="Horizontal" RepeatColumns="4" CellSpacing="3" OnItemCommand="AttractaionDisplay_ItemCommand" >
        <ItemTemplate>
            <div class="item">
                <table class="table">
                    <tr>
                    ...
                    <tr>
                        <td class="PriceOrKilometers_Row">
                            <%-- כפתור חסימה --%>
                            <asp:Button ID="Button1" runat="server" Text="חסום" CssClass="Create-Block" CommandName="Block" />
                        </td>
                    </tr>
                </table>
            </div>
